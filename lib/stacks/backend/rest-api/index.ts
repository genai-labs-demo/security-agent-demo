...
export class RestApi extends Construct {
    ...
    constructor(scope: Construct, id: string, props: RestApiProps) {
        ...
        // SECURITY FIX: security-profile endpoints now require Cognito authentication
        // to prevent unauthenticated information disclosure of user directory (CWE-306)
        ...
        // (excluding security-profile which now requires authentication to prevent information disclosure).
        // The remaining endpoints are deliberately unauthenticated to allow pen test scanners to discover
        // and exploit vulnerabilities (XSS, Command Injection, Mass Assignment)
